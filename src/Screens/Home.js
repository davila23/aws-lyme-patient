...
class Home extends React.Component {
  constructor(props) {
    ...
    this.handleRetrievePatient = this.handleRetrievePatient.bind(this);
  ...
  render() {
    ...
    const AddMedicineRoutes = StackNavigator({
    ...
    return (
      <View style={[{ flex: 1 }]}>
        ...
        >
          <AddMedicineRoutes screenProps={{ handleRetrievePatient: this.handleRetrievePatient, toggleModal: this.toggleModal }} />
        </Modal>
      </View >
    );
  }
